...
class CensusConnectAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        #table = self.TABLE_RESPONSE(QgsProcessingOutputString(self.TABLE_OUTPUT))
        #iface.messageBar().pushMessage("Geography", geo, level=Qgis.Info)
        ...
        get_table([table], level, extent, year)
        ...
        # will ultimately not need returns
