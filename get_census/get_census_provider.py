...
from .get_census_algorithm import CensusConnectAlgorithm


class CensusConnectProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(CensusConnectAlgorithm())
